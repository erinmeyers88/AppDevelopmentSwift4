 ...
 */
//var daysInMonth = ["January" : 31, "February" : 28, "March" : 31, "April" : 30, "May": 31, "June" : 30, "July" : 31, "August" : 31, "September" : 30, "October" : 31, "November" : 31, "Decemeber" : 31]
 ...
 */
if let dayCount = daysInMonth["January"] {
    print("January has \(dayCount) days")
}
...
var shapesAndColors = ["shapesArray": shapesArray, "colorsArray": colorsArray]
 ...
 */
if let shapes = shapesAndColors["shapesArray"] {
    print(shapes.last)
}
