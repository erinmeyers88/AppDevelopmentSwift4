...
//Because foo is defined in the local scope of the for in loop
/*:
...
//Because x is defined in both global and local scope
/*:
...
greeting(greeting: nil, name: "Erin")
greeting(greeting: "what's up", name: "Erin")
/*:
