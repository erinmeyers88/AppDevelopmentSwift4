 ...
 */
var firstComputer = Computer(ram: 0, yearManufactured: 2010)
var secondComputer = Computer(ram: 10, yearManufactured: 2000)
if let first = firstComputer {
    print(first)
}
if let second = secondComputer {
    print(second)
}
