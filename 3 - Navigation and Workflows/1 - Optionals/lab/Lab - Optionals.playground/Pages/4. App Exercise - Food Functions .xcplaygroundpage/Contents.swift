...
func findMeal(mealName: String) -> Meal? {
    return meals[mealName]
}

let whatIAte = findMeal(mealName: "Breakfast")
print(whatIAte!)
/*:
 ...
 */
func checkIfSaved() -> [String: Any] {
    var emptyLog : [String: Any] = [:]
