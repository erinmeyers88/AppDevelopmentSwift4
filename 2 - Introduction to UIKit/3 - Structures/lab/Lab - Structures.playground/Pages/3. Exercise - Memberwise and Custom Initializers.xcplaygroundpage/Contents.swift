 ...
 */
let somePlace = GPS(lat: 51.514004, long: 0.125226)
...
var favoriteBook = Book(title: "Harry Potter", author: "J.K. Rowling", pages: 500, price: 25.00)
print(favoriteBook)
/*:
...
var test = Height(centimeters: 1)
print(test)
var test2 = Height(inches: 1)
print(test2)
